...
const Header = () => {
  ...
  return (
    <div className="relative h-screen w-full flex justify-start items-end">
      <img src={bg} alt="background" className='absolute inset-0 object-cover w-full h-full z-[-1]' />
      <div className="z-[50] flex flex-col ml-5 mb-20 w-full max-w-md md:max-w-2xl lg:max-w-1/3">
